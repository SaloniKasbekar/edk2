...
/**
  ...
  This function handles all HTTP callback events (HttpEventDns, HttpEventConnectTcp,
  HttpEventTlsConnectSession, HttpEventInitSession, and HttpEventTlsConfigured) and
  prints error messages to the screen when an error is encountered during the HTTP
  Boot process.
